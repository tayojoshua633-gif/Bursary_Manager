// lib/utils/nigeria_states_lgas.dart
//
// Nigeria's 36 states + FCT, each mapped to its Local Government Areas.

class NigeriaStatesLgas {
  static const Map<String, List<String>> statesAndLgas = {
    ...
    'Jigawa': [
      ...
      'Jahun', 'Kafin Hausa', 'Kazaure', 'Kiri Kasama', 'Kiyawa',
  ...
  static List<String> get states {
    final list = statesAndLgas.keys.toList();
    list.sort();
    return list;
  }
  ...
  static List<String> lgasForState(String? state) {
    ...
    return statesAndLgas[state] ?? const [];
  }
}
