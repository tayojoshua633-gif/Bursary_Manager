// lib/screens/menus/expenditure_menu.dart
...
class ExpenditureMenu extends StatelessWidget {
  final Map<String, dynamic> currentUser;

  const ExpenditureMenu({super.key, required this.currentUser});
      ...
      body: GridView.extent(
        ...
        children: [
          _permissionMenuCard(
            ...
            color: Colors.purple,
            page: ExpenseListScreen(currentUser: currentUser),
            pageId: 'expenditure/expenses',
          ),
          _menuCard(
            context,
            ...
            pageId: 'expenditure/expense_categories',
          ),
        ],
      ),
    );
